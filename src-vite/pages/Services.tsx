...
export function Services() {
    ...
    const servicesData = [
        {
            title: t('landing.servicesData.0.title'),
            description: t('landing.servicesData.0.description'),
            features: [
                t('servicesData.0.features.0'),
                t('servicesData.0.features.1'),
                t('servicesData.0.features.2'),
                t('servicesData.0.features.3')
            ]
        },
        {
            title: t('landing.servicesData.1.title'),
            description: t('landing.servicesData.1.description'),
            features: [
                t('servicesData.1.features.0'),
                t('servicesData.1.features.1'),
                t('servicesData.1.features.2'),
                t('servicesData.1.features.3')
            ]
        },
        {
            title: t('landing.servicesData.2.title'),
            description: t('landing.servicesData.2.description'),
            features: [
                t('servicesData.2.features.0'),
                t('servicesData.2.features.1'),
                t('servicesData.2.features.2'),
                t('servicesData.2.features.3')
            ]
        },
        {
            title: t('servicesData.3.title'),
            description: t('servicesData.3.description'),
            features: [
                t('servicesData.3.features.0'),
                t('servicesData.3.features.1'),
                t('servicesData.3.features.2'),
                t('servicesData.3.features.3')
            ]
        }
    ];
