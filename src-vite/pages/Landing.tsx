...
export function Landing() {
  ...
  const servicesData = [
    {
      title: t('servicesData.0.title') || "AI & Web Development",
      description: t('servicesData.0.description') || "We build scalable, intelligent, and visually striking web applications powered by cutting-edge AI integrations.",
      features: [t('servicesData.0.features.0'), t('servicesData.0.features.1'), t('servicesData.0.features.2')]
    },
    {
      title: t('servicesData.1.title') || "Data-Driven Operations",
      description: t('servicesData.1.description') || "Transform your business processes with tailored data systems designed to optimize efficiency and decision-making.",
      features: [t('servicesData.1.features.0'), t('servicesData.1.features.1'), t('servicesData.1.features.2')]
    },
    {
      title: t('servicesData.2.title') || "Creative Branding",
      description: t('servicesData.2.description') || "Establish a compelling and memorable identity that resonates with your target audience and distinguishes you from competitors.",
      features: [t('servicesData.2.features.0'), t('servicesData.2.features.1'), t('servicesData.2.features.2')]
    }
  ];

  // Note: I will use direct translations for process and FAQ lists as well
  const processSteps = [
    { number: "01", title: t('processSteps.0.title'), description: t('processSteps.0.description') },
    { number: "02", title: t('processSteps.1.title'), description: t('processSteps.1.description') },
    { number: "03", title: t('processSteps.2.title'), description: t('processSteps.2.description') },
    { number: "04", title: t('processSteps.3.title'), description: t('processSteps.3.description') }
  ];
            ...
            <div className="absolute inset-0 bg-black/5 rounded-[4rem] overflow-hidden">
              <AnimatePresence mode="wait">
                <motion.img
                  ...
                  transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}
                  src={['/Content1.png', '/Content2.png', '/Content3.png'][activeServiceIdx ?? 0]}
