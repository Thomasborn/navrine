...
export default function Work() {
    ...
    if (!mounted || !Array.isArray(worksData)) return <div className="min-h-screen bg-black" />;

    const originalWorksData = [
        { year: "2026", image: "/projects/bisniesgo.jpg", color: "#6b38ff" },
        { year: "2025", image: "/projects/paceflux.png", color: "#bdfb54" },
        { year: "2025", image: "/projects/vora.png", color: "#ff386b" },
